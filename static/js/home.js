// Cores
document.getElementById('home').style.backgroundColor = '#009A60'
document.getElementById('home').style.color = '#fff'
document.getElementsByClassName('container')[0].style.backgroundColor = 'rgba(0, 154, 96, 0.1)'
document.querySelector(":root").style.setProperty("--footBorderColor", "#009A60")



// Carrossel
let carrosselArray = [["../static/images/projetos/carrosel/podcastBanner.png", "DisplayCast", "/projetos/podcast"], ["../static/images/projetos/carrosel/exterminandoDrogasBanner.png", "Exterminando Drogas", "https://www.youtube.com"]];
